...
const Menu = () => {
    ...
    return (
        <div className="menu">
                    ...
                    <div className="menu__box">
                        ...
                        <div className="menu__right">
                            <div className="menu__itm">
                                ...
                                {/*pointa="faq"*/}
                                <a rel='noreferrer' className="menu__itm_nav" href="https://discord.gg/minime" target="_blank"
                                   data-lang="Discord">{translatedTexts.discord}</a>
                                <p className="menu__itm_nav">{translatedTexts.faq}</p>
                                <p onClick={onChangeLanguage} className="menu__itm_nav menu__itm_nav_lng">{translatedTexts.lang}</p>
                                {/*<!-- <a class="menu__itm_nav menu__itm_nav_b" href="https://discord.com/" target="_blank">Join Discord</a> -->*/}
                                {/*<!-- <a class="menu__itm_nav menu__itm_nav_b" href="https://opensea.io/" target="_blank">Open Sea</a> -->*/}
                            </div>

                            <div className="menu__soc"><a rel="noreferrer"
                                                          className="menu__soc_link w-inline-block"
                                                          href="https://www.instagram.com/minime.eth/"
                                                          target="_blank">
                                <svg
                                    className="menu__soc_inst" display="block" viewBox="0 0 22.36 22.36"
                                    xmlns="http://www.w3.org/2000/svg" fill='#fff'>
                                ...
                                <a rel="noreferrer"
                                   className="menu__soc_link w-inline-block"
                                   href="https://twitter.com/minime_eth/" target="_blank">
                                    <svg
                                        className="menu__soc_twit" display="block" viewBox="0 0 23.7 19.43"
                                        xmlns="http://www.w3.org/2000/svg" fill='#fff'>
                                        <g id="B7RVCu.tif">
                            ...
                            <div className="menu__icon_wrap">
                                <div className="menu__icon">
                                    <div className="menu__icon_line"></div>
            ...
            <div className="popup">
                <div className="cont">
                    <div className="menu__itm menu__itm_popup">
                        {/*pointa="about"*/}
                        <p className="menu__itm_nav" data-lang="About Us">О нас</p>
                        {/*pointa="team"*/}
                        <p className="menu__itm_nav" data-lang="Team">Команда</p>
                        {/*pointa="minime"*/}
                        <p className="menu__itm_nav" data-lang="Mini Me">Mini Me</p>
                        <a rel='noreferrer' className="menu__itm_nav" href="https://discord.gg/minime" target="_blank"
                           data-lang="Discord">Discord</a>
                        {/*<p className="menu__itm_nav">Roadmap (soon)</p>*/}
                        {/*pointa="faq"*/}
                        <p className="menu__itm_nav" data-lang="FAQ">Вопросы</p>
                        <p className="menu__itm_nav menu__itm_nav_lng">EN</p>
                        {/*// <!-- <a class="menu__itm_nav menu__itm_nav_b" href="https://discord.com/" target="_blank">Join Discord</a> -->*/}
                        {/*// <!-- <a class="menu__itm_nav menu__itm_nav_b" href="https://opensea.io/" target="_blank">Open Sea</a> -->*/}
                    </div>
                    <div className="menu__soc menu__soc_popup">
                        <a
                            rel="noreferrer"
                            className="menu__soc_link w-inline-block"
                            href="https://www.instagram.com/minime.eth/"
                        ...
                        >
                            <svg className="menu__soc_inst"
                                 display="block" viewBox="0 0 22.36 22.36"
                                 xmlns="http://www.w3.org/2000/svg" fill='#fff'>
